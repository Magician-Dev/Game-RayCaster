package com.magiciandev.g1.texture;

import com.magiciandev.g1.entity.Entity2D;
...
public class TextureSprite extends Entity2D {
    ...
    public void draw(Graphics2D g2) {
        ...
        g2.fillRect((int) (this.getX() - this.getWidth()), (int) (this.getY() - this.getHeight() / 2), (int)this.getWidth(),(int)this.getHeight() / 2);
    }
